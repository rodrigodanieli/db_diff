...
use Migration\Trigger\Application\Diff;
use Migration\Trigger\Application\DiffDto;
...
class Triggers extends Command
{
    ...
    {
        $this
            ->setName("diff:triggers")
            ->setDescription('Execute a diff in Triggers from bases')
