...
use Migration\Procedure\Application\Diff;
use Migration\Procedure\Application\DiffDto;
...
class Procedures extends Command
{
    protected function configure(): void
    {
        $this
            ->setName("diff:procedures")
            ->setDescription('Execute a diff in Procedures from bases')
